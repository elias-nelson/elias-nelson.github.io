...
![](utils/upscayl/1. download_R.png){.shadowed fig-align="center"}
...
![](utils/upscayl/2. select_language.png){.shadowed fig-align="center" width="40%"}

6.  **License agreement**: You’ll see a window with the GNU General Public License information. Simply click "Next".

![](utils/upscayl/3. license.png){.shadowed fig-align="center" width="70%"}
...
![](utils/upscayl/8. additional_tasks.png){.shadowed fig-align="center" width="70%"}

12. **Begin installation**: After confirming all the settings, click "Next" to start the installation process.

![](utils/upscayl/9. installation_process.png){.shadowed fig-align="center" width="70%"}

13. **Complete installation**: Once the installation is complete, click "Finish" to close the installer.

![](utils/upscayl/10. finish_installation.png){.shadowed fig-align="center" width="70%"}
...
![](utils/upscayl/11. download_R_MacOS.png){.shadowed fig-align="center"}
...
![](utils/upscayl/13. RGUI.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/14. hello_world.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/15. arithmetic_program.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/16. hello_world_2.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/17. arithmetic_program_2.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/18. R_editor.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/19. R_graphics_window.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/20. R_data_editor.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/21. R_history_window.png){.shadowed fig-align="center" width="80%"}
...
1.  **Visit [Posit](https://posit.co/)**, **the official RStudio website to download RStudio Desktop**.
    ...
    ![](utils/upscayl/23. Posit_page_2.png){.shadowed fig-align="center"}

    ![](utils/upscayl/22. Posit_page_1.png){.shadowed fig-align="center"}
...
2.  **Choose between RStudio Desktop (free) and RStudio Desktop Pro (Paid).**
    ...
    ![](utils/upscayl/24. RStudio_IDE_download.png){.shadowed fig-align="center"}
...
3.  **Select `DOWNLOAD RSTUDIO`** On the [DOWNLOAD RStudio Desktop](https://posit.co/downloads/) page select `DOWNLOAD RSTUDIO.`
    ...
    ![](utils/upscayl/25. Download_RStudio.png){.shadowed fig-align="center"}
...
4.  **Download the appropriate RStudio Desktop installer for your machine.**
    ...
    ![](utils/upscayl/26. Download_RStudio_Desktop.png){.shadowed fig-align="center"}
    ...
    ![](utils/upscayl/27. RStudio_OS.png){.shadowed fig-align="center"}
...
5.  **Run the installer.**
    ...
    ![](utils/upscayl/28. RStudio_installation.png){.shadowed fig-align="center" width="70%"}
    ...
    ![](utils/upscayl/29. RStudio_location.png){.shadowed fig-align="center" width="70%"}

    RStudio will then begin installing the required files on your system.

    ![](utils/upscayl/30. RStudio_install_process.png){.shadowed fig-align="center" width="70%"}
...
6.  **Launch RStudio and start working**
    ...
    ![](utils/upscayl/31. opening_RStudio.png){.shadowed fig-align="center" width="80%"}

    Once RStudio opens, you'll be greeted by it's main interface, as shown below:

    ![](utils/upscayl/32. RStudio_window.png){.shadowed fig-align="center" width="100%"}
...
![](utils/upscayl/33. open_Global_Options.png){.shadowed fig-align="center" width="100%"}

You should be greeted with the Global Options window as below.

![](utils/upscayl/34. Global Options.png){.shadowed fig-align="center" width="100%"}
...
1.  **Code Formatting (Code** → **Editing)**
    ...
    ![](utils/upscayl/35. Code-Editing.png){.shadowed fig-align="center" width="100%"}
...
2.  **Code Visibility (Code** → **Display)**
    ...
    ![](utils/upscayl/36. Code-Display.png){.shadowed fig-align="center" width="100%"}
...
3.  **Appearance and Personalization (Appearance)**
    ...
    ![](utils/upscayl/37.Appearance-Esitor_theme.png){.shadowed fig-align="center" width="100%"}
...
![](utils/upscayl/38. RStudio_windows.png){.shadowed fig-align="center"}
...
![](utils/upscayl/39. RStudio_Console.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/40. RStudio_Source.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/41. RStudio_Environment.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/42. RStudio_History.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/43. RStudio_Connections.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/44. RStudio_Tutorial.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/45. Rstudio_Files.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/46. RStudio_Plot.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/47. RStudio_Packages.png){.shadowed fig-align="center" width="80%"}
...
![](utils/upscayl/48. RStudio_Help.png){.shadowed fig-align="center" width="90%"}
...
![](utils/upscayl/49. RStudio_Help2.png){.shadowed fig-align="center" width="90%"}
...
Choose the installer that matches your operating system (Windows, Mac or Linux).
    ...
    ![](utils/upscayl/50. download_vscode.png){.shadowed fig-align="center" width="70%"}
...
Read through the license agreement, accept the terms, and click Next to continue.
    ...
    ![](utils/upscayl/51. vscode_license_agreement.png){.shadowed fig-align="center" width="70%"}
...
Click **`Next`** to continue.
    ...
    ![](utils/upscayl/52. vscode_install_location.png){.shadowed fig-align="center" width="70%"}

-   **Step 5: Start Menu Folder**
The default **`Start Menu Folder`** works well for most users. Leave this unchanged and click **`Next`**.

    ![](utils/upscayl/53. vscode_start_menu.png){.shadowed fig-align="center" width="70%"}
...
This step is easy to rush through, but it is worth paying attention here.
    ...
    ![](utils/upscayl/54. vscode_additional_tasks.png){.shadowed fig-align="center" width="70%"}
...
Click Install to begin the installation process.
    ...
    ![](utils/upscayl/55. vscode_click_install.png){.shadowed fig-align="center" width="70%"}

You will see a progress screen while VS Code is being installed.

    ![](utils/upscayl/56. installation_process.png){.shadowed fig-align="center" width="70%"}

-   **Step 8: Finish and Launch**
Once installation is complete, click **`Finish`**.

    ![](utils/upscayl/57. launch_vscode.png){.shadowed fig-align="center" width="70%"}
...
For now, you can leave everything as-is and simply close the welcome tab.
    ...
    ![](utils/upscayl/59. vscode_welcome.png){.shadowed fig-align="center" width="70%"}
...
1.  First off, while in VS Code, to your left you will find an activity bar with options for **`Explorer`**, **`Search`**, **`Source Control`**, **`Run and Debug`** and finally **`Extensions`**. Click on **`Extensions`**.
    ...
    ![](utils/upscayl/60. vscode_extensions.png){.shadowed fig-align="center" width="70%"}
