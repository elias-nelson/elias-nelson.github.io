...
```
1. **`languageserver`**
Implements the Language Server Protocol for R and enables features such as code completion, diagnostics, and function documentation inside VS Code.

2. **`httpgd`**
Implements the Language Server Protocol for R and enables features such as code completion, diagnostics, and function documentation inside VS Code.

3. **`lintr`**
Analyzes your R code and highlights potential issues related to style, syntax, or best practices.
...
-   Step one, obviously, is downloading Visual Studio Code, which you can find on the [Visual Studio Code website](https://visualstudio.microsoft.com/downloads/).
