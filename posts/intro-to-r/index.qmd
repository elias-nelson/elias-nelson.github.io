...
![](images/upscaled/1.%20download_R.png){.shadowed fig-align="center"}
...
![](images/upscaled/2.%20select_language.png){.shadowed fig-align="center" width="40%"}

6.  **License agreement**: You’ll see a window with the GNU General Public License information. Simply click "Next".

![](images/upscaled/3.%20license.png){.shadowed fig-align="center" width="70%"}
...
![](images/upscaled/8.%20additional_tasks.png){.shadowed fig-align="center" width="70%"}

12. **Begin installation**: After confirming all the settings, click "Next" to start the installation process.

![](images/upscaled/9.%20installation_process.png){.shadowed fig-align="center" width="70%"}

13. **Complete installation**: Once the installation is complete, click "Finish" to close the installer.

![](images/upscaled/10.%20finish_installation.png){.shadowed fig-align="center" width="70%"}
...
![](images/upscaled/11.%20download_R_MacOS.png){.shadowed fig-align="center"}
...
![](images/upscaled/13.%20RGUI.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/14.%20hello_world.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/15.%20arithmetic_program.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/16.%20hello_world_2.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/17.%20arithmetic_program_2.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/18.%20R_editor.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/19.%20R_graphics_window.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/20.%20R_data_editor.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/21.%20R_history_window.png){.shadowed fig-align="center" width="80%"}
...
1.  **Visit [Posit](https://posit.co/)**, **the official RStudio website to download RStudio Desktop**.
    ...
    ![](images/upscaled/23.%20Posit_page_2.png){.shadowed fig-align="center"}

    ![](images/upscaled/22.%20Posit_page_1.png){.shadowed fig-align="center"}
...
2.  **Choose between RStudio Desktop (free) and RStudio Desktop Pro (Paid).**
    ...
    ![](images/upscaled/24.%20RStudio_IDE_download.png){.shadowed fig-align="center"}
...
3.  **Select `DOWNLOAD RSTUDIO`** On the [DOWNLOAD RStudio Desktop](https://posit.co/downloads/) page select `DOWNLOAD RSTUDIO.`
    ...
    ![](images/upscaled/25.%20Download_RStudio.png){.shadowed fig-align="center"}
...
4.  **Download the appropriate RStudio Desktop installer for your machine.**
    ...
    ![](images/upscaled/26.%20Download_RStudio_Desktop.png){.shadowed fig-align="center"}
    ...
    ![](images/upscaled/27.%20RStudio_OS.png){.shadowed fig-align="center"}
...
5.  **Run the installer.**
    ...
    ![](images/upscaled/28.%20RStudio_installation.png){.shadowed fig-align="center" width="70%"}
    ...
    ![](images/upscaled/29.%20RStudio_location.png){.shadowed fig-align="center" width="70%"}

    RStudio will then begin installing the required files on your system.

    ![](images/upscaled/30.%20RStudio_install_process.png){.shadowed fig-align="center" width="70%"}
...
6.  **Launch RStudio and start working**
    ...
    ![](images/upscaled/31.%20opening_RStudio.png){.shadowed fig-align="center" width="80%"}

    Once RStudio opens, you'll be greeted by it's main interface, as shown below:

    ![](images/upscaled/32.%20RStudio_window.png){.shadowed fig-align="center" width="100%"}
...
![](images/upscaled/33.%20open_Global_Options.png){.shadowed fig-align="center" width="100%"}

You should be greeted with the Global Options window as below.

![](images/upscaled/34.%20Global%20Options.png){.shadowed fig-align="center" width="100%"}
...
1.  **Code Formatting (Code** → **Editing)**
    ...
    ![](images/upscaled/35.%20Code-Editing.png){.shadowed fig-align="center" width="100%"}
...
2.  **Code Visibility (Code** → **Display)**
    ...
    ![](images/upscaled/36.%20Code-Display.png){.shadowed fig-align="center" width="100%"}
...
3.  **Appearance and Personalization (Appearance)**
    ...
    ![](images/upscaled/37.Appearance-Esitor_theme.png){.shadowed fig-align="center" width="100%"}
...
![](images/upscaled/38.%20RStudio_windows.png){.shadowed fig-align="center"}
...
![](images/upscaled/39.%20RStudio_Console.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/40.%20RStudio_Source.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/41.%20RStudio_Environment.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/42.%20RStudio_History.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/43.%20RStudio_Connections.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/44.%20RStudio_Tutorial.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/45.%20Rstudio_Files.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/46.%20RStudio_Plot.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/47.%20RStudio_Packages.png){.shadowed fig-align="center" width="80%"}
...
![](images/upscaled/48.%20RStudio_Help_1.png){.shadowed fig-align="center" width="90%"}
...
![](images/upscaled/49.%20RStudio_Help_2.png){.shadowed fig-align="center" width="90%"}
...
![](images/38a-RStudio_project1.png){fig-align="center"}

or use the project dropdown in the top-right corner and select **New Project**.

![](images/38b-RStudio_project2.png){fig-align="center"}
...
![](images/45-Project_structure.png){fig-align="center"}
...
To enable {{< fa brands r-project >}} support in VS Code, you will need to install at least one additional {{< fa brands r-project >}} package for **CRAN**.
...
To install packages from **CRAN**, you use the **`install.packages()`** function. For integrating {{< fa brands r-project >}} with VS Code, the following package is particularly important.
...
This package is essential. It allows VS Code to understand your {{< fa brands r-project >}} code and enables features such as code completion, inline diagnostics, function documentation, and object inspection.

While not strictly required, you may also choose ton install the **`lintr`** package:
...
The **`lintr`** package checks your {{< fa brands r-project >}} code for potential issues related to style, syntax, and best practices. It integrates with VS Code to highlight suggestions as you type, helping you develop good coding habits early on.

::: column-margin
- **`lintr`** is optional. If it is not installed, R and VS Code will still work normally.
:::

Together, these packages provide a solid and beginner-friendly foundation for working with {{< fa brands r-project >}} in VS Code.

When you run **`install.packages()`** for the first time, {{< fa brands r-project >}} may ask you to choose a **`CRAN`** mirror. **`CRAN`** short for Comprehensive R Archive Network, is a global network of servers that store {{< fa brands r-poject >}} packages. A CRAN mirror is simply a copy of this repository hosted in different locations around the world.

::: column-margin
- A **`CRAN`** mirror is simply a copy of the same packages hosted in different countries.
:::

You can safely choose any mirror. You can select a mirror closest to your location otherwise If you are unsure, selecting **`0-Cloud / CDN (global)`** at https://cloud.r-project.org/ is usually the best option. This is not a single server, but a content delivery network that automatically serves packages from a location close to you. It often provides the best performance without requiring you to manually choose a nearby country.

Importantly, all **CRAN** mirrors contain the same packages. The choice only affects download speed, not package content.

Most times packages also come with dependencies, which are other packages that help in the functionality of the package hence the name dependency. During the installation process you may be asked, “Do you want to install from sources the packages which need compilation?”

*What does this mean?*
When you install an {{< fa brands r-project >}} package, it can come in two forms:

1. Binary packages (pre-compiled)
- Already built for your operating system (Windows or macOS)
- install quickly
- Do not require extra tools
...
::: column-margin
- Don't let the compiler tools frighten you, we cover them later on in the guide.
:::

So in this case {{< fa brands r-project >}} is asking whether you want to:

- Install from source (compile the package yourself), or

- Use a binary version (if available)

Unless otherwise the recommended answer especially for beginners is **`NO`**, and here is why:

- Binary packages are easier and safer for beginners

- No extra software is required

- Generally fewer errors during installation

{{< fa brands r-project >}} will then install available binary packages, and skip those that require compilation.

*When would `"Yes"` make sense?*
You should only choose Yes if:

- You know what compilation is

- You have the required tools installed (e.g., Rtools)
...
- If {{< fa brands r-project >}} asks about installing from source and you’re not sure — always choose NO.
:::

Once you click NO, {{< fa brands r-project >}} will start installing the packages until you see "The downloaded binary packages are in..."

On Windows and macOS, {{< fa brands r-project >}} usually installs pre-compiled binary packages automatically, so unless tools like **`Rtools`** or **`Xcode`** are installed, this prompt may not appear at all. So don't be confused if this prompt doesn't show for you.

Go ahead and install the remaining two packages; **`"httgpd"`** and **`"lintr"`** using the same process. Apparently also comes as a dependency of **`"languageserver"`** so you may just skip it. But to be sure you may also just intall it separately

In the next sections, we will walk through installing the necessary VS Code extensions and configuring the editor so that it is ready for everyday {{< fa brands r-project >}} development.

##### Installing and integrating {{< iconify logos:visual-studio-code >}} VS Code with {{< iconify logos:r-lang >}}

-   Step one, obviously, is downloading Visual Studio Code, which you can find on the [Visual Studio Code website](https://code.visualstudio.com/Download).

- Download the suitable installer for your machine (Windows, Mac or Linux).

-   VS Code is free and available for Windows, Mac, and Linux. Install it like any other software package.

- For Windows double-clicking the **`.exe`** file should prompt the installation process.

- Accept the agreement as below and click next

- Maintain the default installation location, unless you have a good reason not to and click next

- Maintain the **`Start Menu Folder`** defaults as well and click next.

- Select additional tasks. If you would like a Desktop icon, you can check the box. I also check the other two check boxes so that my files compatible with VS Code can easily be opened with open with in the Windows Explorer file context menu. Click next.

- Finally click install

- After the installation is complete. click finish. VS Code should launch and you will be greeted with the interface below. There is a default welcome file open which you can go through and you're given the option to customize the theme. For now we leave it as is. You can close the file from the top.

Next we have to install the [{{< fa brands r-project >}} extension](https://marketplace.visualstudio.com/items?itemName=REditorSupport.r) for VS Code. The steps below guide on how to do this.
