...
1.  **Navigate to the Extensions view:** First off, while in VS Code, to your left you will find an activity bar with options for **`Explorer`**, **`Search`**, **`Source Control`**, **`Run and Debug`** and finally **`Extensions`**. Click on **`Extensions`** or use the shortcut **`Ctrl + Shift + X`** (**`⌘ + Shift + X`** on MacOS).
